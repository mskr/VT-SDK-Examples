 ...
 */
export declare type HostString = 'https://api-demo-klinik.virtual-twins.com' | string;
 ...
 */
declare interface IVTAppExternalAssets {
    /**
 ...
 */
declare interface IVTAppExternalLocation {
    /**
 ...
 */
declare interface IVTAppExternalRouting {
    /**
 ...
 */
declare interface IVTAppExternalSelection {
    /**
...
export declare type IVTCameraViewOptions = {
    /**
     * A Google Earth camera definition string starting with `@` as in:
     * `https://earth.google.com/web/@51.43,6.99,108.5a`
     */
...
export declare type VT = {
    Map: IVTAppExternal;
};

declare const vt: IVTAppExternal;
export default vt;
